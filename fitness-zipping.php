...
<html lang="uk">
	<head>
		<title>ZipOut - Fitness Zipping</title>
...
<body class="single-event">
	...
	<section class="container">
		<div class="pageHeader" style="background-image: url(images/content/fitness-zipping.jpg);">
        	<h1>Fitness Zipping</h1>
		</div>
		<div class="contentWrap">
			...
			<div class="wrapper">
				<div class="singlePostWrap">
					<p>You can invite ZipOut team to your Residential Park for your morning rendezvous with Dance. We simply call it the ZipOut FitFest. We are commited towards creating a healthy lifestyle and will do that with dance and fitness activities. Short bursts are free but Long term association with RWA's are undertaken on commercial terms.</p>
